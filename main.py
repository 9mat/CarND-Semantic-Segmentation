...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    conv7 = tf.layers.conv2d(vgg_layer7_out, num_classes, 1,  padding='same', kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
    conv4 = tf.layers.conv2d(vgg_layer4_out, num_classes, 1,  padding='same', kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
    ...
    output = tf.layers.conv2d_transpose(conv7, num_classes, 4, 2, padding='same', kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
...
def run():
    ...
    with tf.Session() as sess:
        ...
        train_nn(sess, 50, 16, get_batches_fn, train_op, cross_entropy_loss, input_image, correct_label, keep_prob, learning_rate)
